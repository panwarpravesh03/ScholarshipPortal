...
<title>Institute registration</title><script type="text/javascript" src="instituteRegJS.js"></script>
		<link rel="stylesheet" type="text/css" href="instituteRegCSS.css">



</head>
	<body>
		<div class="formhead" style="text-align: center;">Institute<span>Registration</span>Form</div><br>
		<div class="instituregform">
			<sF:form method="POST" commandName="instituteRegistration" action="submitInsForm" name="insRegForm" enctype="multipart/form-data">
				<div class="container">  
					<div class="formhead">Basic<span>Details</span></div>
					<hr>
					<div class="fdetails">
						<table>
							<tr>
								<td colspan="2">Institute Category <select name="instituteCategory" id="instituteCategory">
														<option disabled selected value= "defaultVal">------------Select Institute Category------------</option>
								...
								<td colspan="2">Institute Name<input type="text" name="instituteName" id="instituteName">
									<div id="instituteName_error" class="errorMsg" ></div>
								</td>
							</tr>

							<tr>
								<td colspan="2">State<br><select name="state" id="state" size="1" onchange="makeSubmenu(this.value)">
															<option value= "defaultVal" disabled selected>------------Select State------------</option>
								...
								<td colspan="2">District<select name="district" id="district" >
															<option value="defaultVal" disabled selected>---------Choose City-------</option>
														</select>
							...
							<tr>
									...
									<td colspan="2">Location <select id="location" name="location" >
														<option disabled selected value="defaultVal">------------Select Location------------</option>
														<option >Rural</option>
														<option >Urban</option>
														</select>
							...
							<tr>
									<td colspan="2">Institute Type <select id="type" name="type" >
														<option disabled selected value="defaultVal">------------Select Institute Type------------</option>
									...
									<td colspan="2">Affiliated University State <select id="aff" name="aff" >
														<option value="defaultVal" disabled selected>------------Select Affiliated Institute State------------</option>
														<option >Andaman and Nicobar Islands</option>
														<option >Andhra Pradesh</option>
														<option>Arunachal Pradesh</option>
														<option >Assam</option>
							...
							<tr>
									<td colspan="2">Affiliated University/Board id<select id="affUniName" name="affUniName" >
																	<option value="defaultVal" disabled selected>------------Select Affiliated Institute Name------------</option>
																	<option >Mumbai University</option>
																	<option >Shivaji University</option>
																	<option >North Maharashtra University</option>
																	<option >Gondwana University</option>
																	<option>University of Solapur</option>
																	</select>
										<div id="affUniName_error" class="errorMsg" ></div>
									</td>		 					
									<td colspan="2">Year From Which Admission Started<input type="date" name="yearFromAdmissionStarted" id="yearFromAdmissionStarted">
										<div id="yearFromAdmissionStarted_error" class="errorMsg" ></div>
									</td>
							</tr>
							<tr>
									<td colspan="2">Set Password<br><input type="password" id="password" name="password">
										<div id="ispwd_error" class="errorMsg" ></div>
									</td>
									<td colspan="2">Confirm Password<input type="password" name ="iconfpwd" id="iconfpwd">
				...
				<br><br><br>
				 <div class="container">  
					<div class="formhead">Proof<span>Of</span>Existence<span>Of</span>Institue</div>
					<hr>  
					<div class="fdetails"> 
					
							Institute Establishment/Registration Certificate<input type="file"  name="files" id="files"  /><br>
				...
				<br><br><br>
				<%-- <div class="container">  
					<div class="formhead">Affiliated<span>To</div> 
					<hr> 
					<div class="fdetails">
						Univeristy/Board Affilaition Certificate<input type="file" path="file"  id="uniAffCerti" />
						<div id="uniAffCerti_error" class="errorMsg" >${errorMessage}</div>
					</div>
				</div>  
				<br><br><br> --%>
				<!--<div class="container">  
					<div class="formhead">De<span>tails</span></div>
					<hr>  
					<div class="fdetails">  
						<table>
							<tr>
								<td colspan="2">Address<br><input type="text" id="address" >
				...
				<br><br><br>
				<div class="container">
					<div class="formhead">Contact<span>Details</span></div>
					<hr>  
					<div class="fdetails">  
						<table>
							<tr>
								<td colspan="2">Principal Name<input type="text" id="principalName">
									<div id="principalName_error" class="errorMsg" ></div>
								</td>
								<td colspan="2">Mobile Number<input type="Number"  id="principalMobileNumber">
				...
				<div class="container">
			    	<div class="fdetails">
				   		 <input type="checkbox" id="iaccept" required > All the details and documents submitted by us are valid and true . If found guilty of submitting invalid documents, we may be held responsible for that act by us
					</div>
				</div>
				<br><br><br>
				<div class="container">  
				    ...
				    <div class="fdetails">
				    	<table>
				    		<tr>
				    			<td colspan="2"><div class="formhead">Sub<span>mit</span></div><input type="submit" value="Submit Form" onclick="return validation()"></td>
				    			<td colspan="2"><div class="formhead">Res<span>et</span></div><input type="reset"></td>
				    		</tr>
				    	</table>
				    </div>
			    </div> 
