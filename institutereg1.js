...
function validation()
{
      var inscag = document.forms["insRegForm"]["inscag"]; 
      var iname = document.forms["insRegForm"]["iname"];
      var stateSel = document.forms["insRegForm"]["stateSel"];               
      var districtSel = document.forms["insRegForm"]["districtSel"];
      var inscode = document.forms["insRegForm"]["inscode"];  
      var disecode = document.forms["insRegForm"]["disecode"];              
      var itype = document.forms["insRegForm"]["itype"];              
      var iaffstate = document.forms["insRegForm"]["iaffstate"]; 
      var iaffuniv = document.forms["insRegForm"]["iaffuniv"];              
      var iadmstart = document.forms["insRegForm"]["iadmstart"];
      ...
      var ipriname = document.forms["insRegForm"]["ipriname"]; 
      var imobno = document.forms["insRegForm"]["imobno"];
      var itele = document.forms["insRegForm"]["itele"];
      ...
      var today = new Date();
       ...
       if (inscag.value=="defaultVal")                                  
      { 
           document.getElementById('inscag_error').innerHTML = "*field can't be empty";
           inscag.focus(); 
           submit="false"; 
       }
...
document.getElementById("inscag").onchange= removeWarning;
document.getElementById("iname").onchange= removeWarning;
document.getElementById("stateSel").onclick= removeWarning;
document.getElementById("districtSel").onchange= removeWarning;
document.getElementById("inscode").onkeyup= removeWarning;
document.getElementById("disecode").onkeyup= removeWarning;
document.getElementById("itype").onchange= removeWarning;
document.getElementById("iaffstate").onchange= removeWarning;
document.getElementById("iaffuniv").onchange= removeWarning;
